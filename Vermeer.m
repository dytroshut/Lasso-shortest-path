...
%
% weights_opt = 1000*weights+rand(size(weights))+1;
...
% Since we have the Pa vector, we need to convert to a matrix as in 
...
[z_cg, history_cg] = lassoInADMM_cg(D, Y, lambda, 1e-9, 1.0);
%[z_cg, history_cg] = lassoADMM(D, Y, lambda, 1e-9, 1.0); %-9
